...
//enquanto nao for passado nenhum valor
// A vai estar recebendo false, quando clicar em zerar,
//vai receber true e vai zerar
let zerado = false;
function diminuir(a){//esta sendo passado o valor true
    console.log(a);
    let time = setInterval(() => {
        if(a == true) {
            stop()
            console.log('pegou o valor true');
        }
